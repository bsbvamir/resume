...
\name{Amir Beisembayev}
\address{\\ North York, Ontario, Canada  }
\address{ 437~$\cdot$~518~$\cdot$~1337 \\ bsbv.amir@gmail.com }
...
\begin{document}
  ...
  \begin{rSection}{Education}
    {\bf University of Toronto, Toronto, Canada} \hfill {\em September 2021 - Present } \\ 
    { Bachelor of Science } \\
    { Major in Mathematics } \smallskip \\
